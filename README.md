# YOLOv8 Object Detection on a custom dataset | 6 sided dice detection

## <div align="left">Objective</div>
I trained [Ultralytics YOLOv8 object detection model](https://github.com/ultralytics/ultralytics/tree/main) on a custom dataset. The dataset I used is 6 sided dice dataset available at [roboflow](https://public.roboflow.com/object-detection/dice).
...
<img width="100%" src="https://github.com/wideflat/yolov8-dice-detection/blob/main/runs/detect/train/PR_curve.png">

##### Confusion Matrix
<img width="100%" src="https://github.com/wideflat/yolov8-dice-detection/blob/main/runs/detect/train/confusion_matrix_normalized.png">
